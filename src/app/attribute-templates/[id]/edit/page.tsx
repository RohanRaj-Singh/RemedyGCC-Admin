...
import { getTemplateById, updateTemplate } from '@/modules/attribute-template/service';
...
export default function EditTemplatePage({ params }: EditTemplatePageProps) {
  ...
  useEffect(() => {
    const loadTemplate = async () => {
      ...
      setFunctionField(data.function);
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-500 mt-1">Update template: {template?.name}</p>
      </div>
