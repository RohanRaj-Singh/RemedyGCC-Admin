...
/**
 * Super Admin — Accounts Receivable Ledger
 *
 * Proxies to the Tenant App's `/api/invoices/ledger` endpoint with the shared
 * API key. Returns the org-first A/R ledger:
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const targetUrl = new URL(`${tenantAppUrl}/api/invoices/ledger`);
